...
namespace NFL2K5Tool
{
	...
	public class SchedulerHelper
	{
		...
		public bool AUTO_CORRECT_SCHEDULE = true;
		...
		private byte[] GetDefaultSchedule()
		{
			...
			try
			{
				System.IO.Stream fs =  this.GetType().Assembly.GetManifestResourceStream ("NFL2K5_Tool.NFL2004-05.nfl2k5");
				long size = fs.Length;
				ret = new byte[size];
